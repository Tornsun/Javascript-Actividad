...
//Metodo para eliminar elmentos del principio de un arreglo
asignaturas.shift();
console.log(asignaturas);

//Metodo para saber si mi arreglo incluye un elemento especifico

let carritoDeWalmart = ["Gansitos", "Coquita", "Galleta Maria", "Mazapan",];
...
var amigos = ["Felipe", "Mariana", "Fernanda", "Maara", "Gaby", "Marina"];
 ...
 var listaDeGolosinas = ["Gansitos", "Coquita", "Galleta Maria", "Mazapan",];

 var listaDeVerduritas = ["Manzanas", "Mangos", "Toronjas", "Platanos", "Fresas"];

 var listaDeComprasDeLaQuincena = listaDeGolosinas.concat(listaDeVerduritas);

 console.log(listaDeComprasDeLaQuincena);

 console.log(listaDeGolosinas, listaDeVerduritas);

 //Metodo para buscar un elemento en un arreglo y devolver el indice de su primera aparaicion. Si el elemento no se encuentra, retorna -1
